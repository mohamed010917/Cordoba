        ...
        <div class="px-4 sm:px-6 lg:px-8 py-6 space-y-5">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Showing
                    <span class="font-medium text-gray-700 dark:text-gray-200">{{ page.props.users?.from ?? 0 }}</span>
                    –
                    <span class="font-medium text-gray-700 dark:text-gray-200">{{ page.props.users?.to ?? 0 }}</span>
                    of
                    <span class="font-medium text-gray-700 dark:text-gray-200">{{ page.props.users?.total ?? 0 }}</span>
                    users
                </p>
